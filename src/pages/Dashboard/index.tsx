...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const formattedTransactions: Transaction[] = transactionsGet.map(
        transaction => {
          let signal = '';
          ...
          const formattedValue =
            signal + formatValue(Number(transaction.value));
      ...
      const formattedBalance = {
        income: formatValue(+balanceGet.income),
        outcome: formatValue(+balanceGet.outcome),
        total: formatValue(+balanceGet.total),
      };
